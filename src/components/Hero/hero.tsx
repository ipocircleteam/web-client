...
export default function Hero() {
  return (
    <div className="my-6 md:my-4 text-center">
      <span className="flex justify-center items-center w-[90vw] mx-auto">
      ...
      <p className="my-4 md:my-2 text-[1.1rem] md:text-[1.3rem] leading-tight text-primary w-[90vw] mx-auto">
