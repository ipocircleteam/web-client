export default function Gmptable(props: { data: any }) {
  return (
    <div className="mb-[50px] mt-[20px] w-[100%] md:w-[80%] lg:w-[70%] mx-auto border rounded-lg p-1 md:p-4">
      <table className="w-[100%] border text-[12px] md:text-[18px] lg:text-[20px]">
        <tr className="grid grid-cols-6 border-collapse border font-semibold text-primary items-center p-1 min-h-[50px] text-center">
          <td>IPO Name</td>
          <td>GMP(%)</td>
          <td>GMP (absolute)</td>
          <td>Issue Price</td>
