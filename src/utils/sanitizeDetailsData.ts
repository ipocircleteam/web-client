...
export default async function sanitizeIpoDetailsData(content: any) {
  const formattedData: ContentType = {
    ...
    LotSizeData: {
      min_retail_lots: content.data[0].min_retail_lots || 0,
      max_retail_lots: content.data[0].max_retail_lots || 0,
      min_shni_lots: content.data[0].min_shni_lots || 0,
      max_shni_lots: content.data[0].max_shni_lots || 0,
      min_bhni_lots: content.data[0].min_bhni_lots || 0,
      max_bhni_lots: content.data[0].max_bhni_lots || 0,
      min_retail_shares: content.data[0].min_retail_shares || 0,
      max_retail_shares: content.data[0].max_retail_shares || 0,
      min_shni_shares: content.data[0].min_shni_shares || 0,
      max_shni_shares: content.data[0].max_shni_shares || 0,
      min_bhni_shares: content.data[0].min_bhni_shares || 0,
      max_bhni_shares: content.data[0].max_bhni_shares || 0,
      min_retail_price: content.data[0].min_retail_price || 0,
      max_retail_price: content.data[0].max_retail_price || 0,
      min_shni_price: content.data[0].min_shni_price || 0,
      max_shni_price: content.data[0].max_shni_price || 0,
      min_bhni_price: content.data[0].min_bhni_price || 0,
      max_bhni_price: content.data[0].max_bhni_price || 0,
    },
    PerformanceData: {
